...
<div class="container">
    <div class="body-container" style="width: 900px;">
        ...
        <div>
        <img src="<%=cp%>/resource/img/m_foodboard2.png" style="margin: 10px">
			...
			<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
			   <tr height="40">
			      <td align="left" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/food/recipe.do';">새로고침</button>
			      </td>
			      <td align="center">
			      ...
			      <td align="right" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/food/recipe_created.do';">글올리기</button>
			      </td>
			   </tr>
			</table>
        </div>
