...
<script type="text/javascript">
    function sendOk() {
    	...
    	var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/it/news_created_ok.do";
    	else if(mode=="update")
    		f.action="<%=cp%>/it/news_update_ok.do";
       	else if(mode=="reply")
       		f.action="<%=cp%>/it/news_reply_ok.do";
			  ...
			  <table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        ...
			        <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/it/news.do';">${mode=='update'?'수정취소':'등록취소'}</button>
