...
<c:forEach var="vo" items="${listReply}">
    <!-- 리플 내용 리스트 시작 -->
    <div style="clear:both; margin-top:5px; padding: 10px; border: #d5d5d5 solid 1px; min-height: 30px;">
        <div style="clear: both;">
            <div style="float: left;">${vo.mem_Name} | ${vo.created}</div>
            <div style="float: right;  text-align: rigth;">
<c:if test="${sessionScope.member.mem_Id==vo.mem_Id || sessionScope.member.mem_Id=='admin'}">		   
