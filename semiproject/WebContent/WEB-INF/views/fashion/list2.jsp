...
<script type="text/javascript">
	function searchList() {
		...
		f.action="<%=cp%>/fashion/Fashion2.do";
		f.submit();
	}
			...
			<tr height="40">
				<td align="left" width="100">
					<button type="button" class="btn"
						onclick="javascript:location.href='<%=cp%>/fashion/Fashion2.do';">새로고침</button>
				</td>
				<td align="center">
				...
				<td align="right" width="100">
					<button type="button" class="btn"
						onclick="javascript:location.href='<%=cp%>/fashion/Fashion2_created.do';">글올리기</button>
				</td>
			</tr>
		</table>
	</div>
