			...
			<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
			   <tr height="40">
			      <td align="left" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/pet/petTalk/list.do';">새로고침</button>
			      </td>
			      <td align="center">
			      ...
			      <td align="right" width="100">
			          <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/pet/petTalk/created.do';">글올리기</button>
			      </td>
			   </tr>
			</table>
        </div>
